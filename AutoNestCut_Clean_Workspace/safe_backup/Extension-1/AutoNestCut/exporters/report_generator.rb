  ...
  class ReportGenerator
    ...
    def export_csv(filename, report_data)
      CSV.open(filename, 'w') do |csv|
        ...
        csv << ["Name", "Width(mm)", "Height(mm)", "Thickness(mm)", "Material", "Grain Direction", "Edge Banding", "Total Quantity", "Total Area(mm²)"]
        ...
        csv << ["Unique ID", "Name", "Width(mm)", "Height(mm)", "Thickness(mm)", "Material", "Area(mm²)", "Board#", "X Pos(mm)", "Y Pos(mm)", "Rotated", "Grain Direction", "Edge Banding"]
